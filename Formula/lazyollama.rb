...
class Lazyollama < Formula
    ...
    url "https://github.com/webmatze/lazyollama/archive/refs/tags/v0.3.0.tar.gz" # URL to the source tarball of a specific release
    sha256 "29545a5688ccf029062f2654c5d218f0d0658606e6881c69b01c2291b09a3b49" # SHA256 hash of the tarball
    ...
    test do
      ...
      assert_match "lazyollama 0.3.0", shell_output("#{bin}/lazyollama --version")
